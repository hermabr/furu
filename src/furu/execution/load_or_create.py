...
def _store_result[T](
    ...
    *,
    ...
    declared_type = obj._result_declared_type
    ...
    save_result = _save_result_bundle(
        result,
        tmp_result_dir,
    ...
    if save_result.should_reload_value_after_save:
        return cast(
            T,
            load_result_bundle(
    ...
    rebind_refs_to_published(save_result, result_dir=result_dir, data_dir=data_dir)
    return result
