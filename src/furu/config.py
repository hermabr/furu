...
@dataclass(slots=True)
class _FuruResultSettings:
    def default_config(self) -> ResultConfig:
        return ResultConfig.default()
...
class _FuruConfig:
    ...
    results: _FuruResultSettings = field(default_factory=_FuruResultSettings)
